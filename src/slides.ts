...
// import { DynamicUIThemes } from "./intro/dyanamicUI";

import { Web3Carousel } from "./intro/web3";
import ArchiveBoardPage from "./components/archiveboard/archivepage";
import { Agenda as BrexPresentation } from "./intro/brex-presentation";
//import { Storybook } from "./tldr/storybook";
// import ImageBlock from "./intro/imageblock";
// import ArchiveBoard from "./components/ArchiveBoard/ArchiveBoard";
...
// Row 1 (top row) - 6 slides: BoxCarousel → ArchiveBoard → Storybook → Web3 → DynamicUI → ThinkingAbout
const slide01 = { id: "01", data: { left: "31", right: "05", down: "06", component: BoxCarouselDemo } }; // Box Carousel Demo
...
// const slide04 = { id: "04", data: { left: "25", right: "06", down: "13", component: ThinkingAbout } }; // Thinking About - at end of row 1
const slide05 = { id: "05", data: { left: "01", right: "24", down: "07", component: ArchiveBoardPage } }; // Archive Board
const slide24 = { id: "24", data: { left: "05", right: "27", down: "08", component: DesignSystems } }; // Design Systems
// const slide25 = { id: "25", data: { left: "27", right: "04", down: "09", component: DynamicUIThemes } }; // Dynamic UI Themes
const slide27 = { id: "27", data: { left: "24", right: "31", down: "08", component: Web3Carousel } }; // Web3 Carousel
const slide31 = { id: "31", data: { left: "27", right: "01", down: "08", component: BrexPresentation } }; // Brex Presentation
//const slide30 = { id: "30", data: { left: "05", right: "27", down: "07", component: Storybook } }; // Storybook Illustrations
// const slide28 = { id: "28", data: { left: "27", right: "29", down: "15", component: ArchiveBoardPage } }; // ArchiveBoard (unused)
// const slide29 = { id: "29", data: { left: "28", right: "04", down: "06", component: ImageBlock } }; // Image Block (unused)

// Row 2 - ALL DirectExpress components (8 slides) with flow to next row
const slide06 = { id: "06", data: { left: "27", right: "07", up: "01", component: HeroDirectExpress } }; // left goes back to last slide of row 1
const slide07 = { id: "07", data: { left: "06", right: "08", up: "02", component: PersonasDex } };
const slide08 = { id: "08", data: { left: "07", right: "09", up: "05", component: MobileflowsDex } };
const slide09 = { id: "09", data: { left: "08", right: "10", up: "05", component: TechnicalFeaturesDirectExpress } };
const slide10 = { id: "10", data: { left: "09", right: "13", up: "05", component: PillarsDex } };
// const slide11 = { id: "11", data: { left: "10", right: "12", up: "05", component: AtmDex } };
// const slide12 = { id: "12", data: { left: "11", right: "13", up: "05", component: BillpayDex } };
const slide13 = { id: "13", data: { left: "10", right: "01", up: "05", component: TrustDex } }; // right wraps to first slide
...
const slideArray = [slide01, slide05, slide24, slide27, slide31, slide06, slide07, slide08, slide09, slide10,
 slide13];
...
export const slidesToElements = (
  ...
  const gridLayout = {
    // Row 1 (top row) - 5 slides: BoxCarousel → ArchiveBoard → DesignSystems → Web3 → BrexPresentation
    row1: ["01", "05", "24", "27", "31"],
    // Row 2 (DirectExpress) - 6 slides  
    row2: ["06", "07", "08", "09", "10", "13"]
  };

    ...
    <section className="h-full flex flex-col p-2">
      ...
      <div className="flex-1 flex flex-col min-h-0">
        <Tabs defaultValue="tab-1" className="flex-1 flex flex-col min-h-0">
          <div className="flex-shrink-0 mb-2">
            <div className="max-w-[100vw-1rem] overflow-x-auto">
              <TabsList className="mx-auto flex w-fit justify-center gap-1 border-b border-gray-200 bg-transparent p-0">
                <TabsTrigger
                  value="tab-1"
                  className="flex flex-col items-center gap-1 px-2 py-1 text-xs font-medium text-gray-600 hover:text-gray-900 data-[state=active]:text-blue-600 data-[state=active]:border-b-2 data-[state=active]:border-blue-600 min-h-[60px] bg-transparent data-[state=active]:bg-transparent"
                >
                  <span className="flex size-8 items-center justify-center rounded-md bg-gray-100 data-[state=active]:bg-blue-100 transition-colors">

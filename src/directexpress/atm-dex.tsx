...
const FEATURES = [
  {
    ...
    description: 'Dual-mode ATM discovery',
    content: {
      title: 'Map & List View ',
      description: `Dual-mode ATM discovery with searchable map pins that supports location-based auto-detection.`,
  ...
  {
    title: 'Filtering',
    description: 'Filter ATMs',
    content: {
      title: 'Filters:',
      description:
        'ATMs by surcharge-free status, accessibility features, and network-type.',
  ...
  },
  {
    ...
    description: 'Directions to selected ATM locations',
    content: {
      title: 'Details & Navigation',
      description:
        'Direct deep-linking to Google and Apple Maps for turn-by-turn directions to selected ATM locations.',
  ...
  },
  {
    ...
    description: 'Full disclosure of fees',
    content: {
      title: 'Fee Transparency',
      description:
        'Full disclosure of domestic and international fees, and clear indication of in-network ATM status.',
  ...
  return (
    <section id="atm" className="py-16 md:py-28 lg:py-32">
      <div className="container">
        <SectionHeader
            category="SOLUTION"
            title="An ATM Locator with Interactive Maps and Smart Filtering"
            icon={Lightbulb}
            description=""
